...
import { User, KeyRound, UploadCloud, GripVertical, Clock, PlayCircle, X, ChevronRight, ListVideo, Terminal, RefreshCw, Image as ImageIcon } from 'lucide-react';
...
export default function App() {
  ...
  const renderStep = () => {
    // ... (The renderStep logic will be complex, breaking it down)
    switch (appStep) {
        case 'credentials':
            // ... (same as before)
            return (
